...
// auth routes
authRouter.post("/register", upload("profiles", 10).single("avatar"), validateRequest(userValidations.creatUserValidationSchema, userUtils.deteteUploadedPhotoIfValidationFailed), userControllers.createUser);
