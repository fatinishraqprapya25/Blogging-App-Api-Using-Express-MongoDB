...
commentRouter.patch("/reply/:commentId/:replyId", varifyToken, validateRequest(commentValidations.updateReplyComment), commentUtils.checkAdminOrAuthorForDelete, commentControllers.updateReply);
